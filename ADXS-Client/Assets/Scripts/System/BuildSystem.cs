...
namespace Assets.Scripts.Modules.Role
{
    ...
    public class BuildSystem : SystemBase<BuildSystem>
    {
        ...
        public GameUnitName testPreviewUnitName;
        [ShowButton]
        public void TestBuild()
        {
            EnterPreview(testPreviewUnitName);
        }
        ...
        private void EnterPreview(GameUnitName name)
        {
            ...
            StartCoroutine(UpdatePreview(previewBuilding));
        }
        ...
        private IEnumerator UpdatePreview(GameBuildingCtrl previewBuilding)
        {
            ...
            previewBuilding.SetBuildMat(buildMat, true);
            ...
            while (true)
            {
                ...
                if (Input.GetMouseButtonDown(0))
                {
                    ...
                    else
                    {
                        ...
                        StartBuild(previewBuilding, buildMat);
                        yield break;
                    }
                }
                yield return null;
        ...
        private void StartBuild(GameBuildingCtrl previewBuilding, Material buildMat)
        {
            StartCoroutine(ExecuteBuild(previewBuilding, buildMat));
        }

        private IEnumerator ExecuteBuild(GameBuildingCtrl previewBuilding, Material buildMat)
        {
            ...
            while (currentTime < previewBuilding.buildTime)
            {
                ...
                buildMat.SetFloat(shaderId_BuildProgress, Mathf.Clamp01(1 - progress));
                currentTime += Time.deltaTime;
                yield return null;
            }
            previewBuilding.SetBuildMat(buildMat, false);
