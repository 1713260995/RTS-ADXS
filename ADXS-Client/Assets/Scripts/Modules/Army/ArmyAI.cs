...
namespace Assets.Scripts.Modules
{
    public class ArmyAI
    {
        ...
        public void Move(Vector3 point)
        {
            roleCtrls.ForEach(o =>
            {
                if (o is IMove move) move.Move(point);
            });
        }

        public void Attack(GameUnitCtrl enemy)
        {
            roleCtrls.ForEach(o =>
            {
                if (o is IAttack a) a.Attack(enemy);
            });
        }
        ...
        public void Lumbering(TreeCtrl tree)
        {
            roleCtrls.ForEach(o =>
            {
                if (o is ILumbering a) a.Lumbering(tree);
            });
        }
        ...
        public void Mining(GoldMine goldMine)
        {
            roleCtrls.ForEach(o =>
            {
                if (o is IMining a) a.Mining(goldMine);
            });
        }
        #endregion
    }
